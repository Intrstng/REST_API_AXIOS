...
import { ResponseGetTasksType, ResponseTaskType, taskApi, TaskType } from '../api/task-api';
...
export const CreateTask = () => {
    const [state, setState] = useState<ResponseTaskType<{ item: TaskType }> | null>(null);
...
export const DeleteTask = () => {
    const [state, setState] = useState<ResponseTaskType | null>(null);
    // useEffect(() => {
    //     const todoID = 'a03a2417-0606-46ae-893b-4ed8ed66119f';
